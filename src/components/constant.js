...
export const formEditAvatar = document.querySelector('.form_content_edit-avatar');// форма с добавлением новой картинки
...
const token = 'a81905a8-70e9-49b5-82c2-f5f8e94b1f23';
